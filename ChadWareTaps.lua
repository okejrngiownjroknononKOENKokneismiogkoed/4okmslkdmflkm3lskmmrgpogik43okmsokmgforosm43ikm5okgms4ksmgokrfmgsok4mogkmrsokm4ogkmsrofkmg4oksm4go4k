...
TextLabel.TextStrokeTransparency = 0.000
	...
	antiaim:Element("Dropdown", "pitch", {options = {"up", "down", "180", "180+", "random", "crazy", "normal", "normal+", "weird", "down+", "up+", "extend", "fake nohead", "imposter", "God"}}) 
...
effects:Element('Toggle', 'out of field of view arrows', {}, function(tbl)
		...
		if tbl.Toggle then
			OldGunSounds = game:GetService("RunService").RenderStepped:Connect(function()
				pcall(function()
					...
					if player.EquippedTool.Value == "P200w0" then
	...
	client:Element("Toggle", "	 killers", {}, function(tbl) 
		if tbl.Toggle then 
...
TextLabel.Font = Enum.Font.Code
TextLabel.Text = "Chad.Ware[Dev Build]"
TextLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
TextLabel.TextSize = 14.000
TextLabel.TextStrokeTransparency = 0.000
...
spawn(function()
	...
	chat:Element("Slider", "speed (ms)", {min = 1, max = 500, default = 50}) 
